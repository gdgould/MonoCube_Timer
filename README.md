...
<b>NOTE</b>: MonoCube Timer 0.5.0.1 (beta/development version) has been tested on the following platforms:
...
### Important
MonoCube Timer 0.5.0.0 (the stable version) runs only on Windows, due to lack of cross-platform file system support
